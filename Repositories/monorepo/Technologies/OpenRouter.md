...
## Objective
Explain how OpenRouter is used in this repo, why it is present, when it runs, and what contracts it affects.

## Description
### What
OpenAI-compatible LLM routing endpoint used by the KFL voice agent.

### Why
It gives the first-party runtime model flexibility while preserving streaming chat-completion semantics.

### When
Used by `streamLLM` with SSE token parsing.
