...
## Objective
Explain how Go is used in this repo, why it is present, when it runs, and what contracts it affects.

## Description
### What
Language used for the first-party KFL voice-agent runtime.

### Why
Go fits long-lived concurrent network sessions with goroutines, channels, mutexes, and explicit cancellation.

### When
Used in `kfl-voice-agent` WebSocket runtime and tests.
